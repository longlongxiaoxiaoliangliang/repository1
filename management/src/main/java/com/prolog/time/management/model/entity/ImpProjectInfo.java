...
public class ImpProjectInfo implements Serializable {
    private static final long serialVersionUID = 4444027239100620999L;
    ...
    public float getContract_money() {
        return contract_money;
    }

    public void setContract_money(float contract_money) {
